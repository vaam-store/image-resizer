...
- API version: 0.1.2
- Build date: 2026-08-19T10:06:23.473841672Z[Etc/UTC]
- Generator version: 7.25.0-SNAPSHOT



This autogenerated project defines an API crate `gen-server` which contains:
...
#[async_trait]
impl gen_server::apis::default::Api for ServerImpl {
  // API implementation goes here
}

impl gen_server::apis::ErrorHandler for ServerImpl {}
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = gen_server::server::new(Arc::new(ServerImpl));
